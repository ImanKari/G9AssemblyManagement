...
public class G9AssemblyManagementUnitTest
{
    ...
    public void TestGetInheritedTypesOfType()
    {
        ...
        Assert.That(getInheritClassType.Count == 1);
        Assert.That(getInheritClassType.All(s => typesName.Contains(s.Name)));
        ...
        Assert.That(getInheritInterfaceType.Count == 2);
        Assert.That(getInheritInterfaceType.All(s => typesName.Contains(s.Name)));
        ...
        Assert.That(getInheritGenericAbstractClassType.Count == 2);
        Assert.That(getInheritGenericAbstractClassType.All(s => typesName.Contains(s.Name)));
        ...
        var getInheritGenericAbstractClassTypeWithoutIgnoreInterfaceAndAbstractType =
            G9Assembly.TypeTools.GetInheritedTypesFromType(typeof(G9ATestGenericAbstractClass<,,,>),
                false,
                false);
        Assert.That(getInheritGenericAbstractClassTypeWithoutIgnoreInterfaceAndAbstractType.Count == 3);
        Assert.That(
        ...
        Assert.That(getInheritGenericInterfaceType.Count == 2);
        Assert.That(getInheritGenericInterfaceType.All(s => typesName.Contains(s.Name)));
        ...
        var getInheritGenericInterfaceTypeWithoutIgnoreInterfaceAndAbstractType =
            G9Assembly.TypeTools.GetInheritedTypesFromType(typeof(G9ITestGenericInterface<,,,>),
                ...
                false,
                Assembly.GetExecutingAssembly());
        Assert.That(getInheritGenericInterfaceTypeWithoutIgnoreInterfaceAndAbstractType.Count == 3);
        Assert.That(
    ...
    public void TestEfficientTypeFeatures()
    {
        ...
        // Checking they are built-in .NET types
        // First way
        Assert.That(G9Assembly.TypeTools.IsTypeBuiltInDotNetType(cObject.GetType()), Is.False);
        // First way
        Assert.That(G9Assembly.TypeTools.IsTypeBuiltInDotNetType(cObject.GetType()), Is.False);
    }
    ...
    public void TestG9AttrAddListenerOnGenerate()
    {
        ...
        Assert.That(firstTestClassInstances1.First().GetClassName() == nameof(G9CInstanceTest));
        // The second way
        var firstTestClassInstances2 = G9Assembly.InstanceTools
            .GetInstancesOfType(typeof(G9CInstanceTest))
            .Select(s => (G9CInstanceTest)s);
        Assert.That(firstTestClassInstances2.First().GetClassName() == nameof(G9CInstanceTest));
        ...
        Assert.That(firstTestStructInstances1.First().GetFirstName() == firstName);
        // The second way
        ...
        Assert.That(firstTestStructInstances2.First().GetFirstName() == firstName);
        ...
        Assert.That(firstTestCustomTypeInstances1.Count == 3);
        // The second way
        var firstTestCustomTypeInstances2 = G9Assembly.InstanceTools
            .GetInstancesOfType(typeof(Trait))
            .Select(s => (Trait)s);
        Assert.That(firstTestCustomTypeInstances2.Count() == 3);
        // Test values
        Assert.That(firstTestCustomTypeInstances1.All(s => arrayValue.Contains(s.Value)));
        ...
        Assert.That(firstTestCustomTypeInstances1.Count == 1);
#endif
        ...
        {
            Assert.That(thirdClass.GetClassName() == nameof(G9CMultiInstanceTest));
            instances = G9Assembly.InstanceTools.GetInstancesOfType<G9CMultiInstanceTest>();
            Assert.That(instances.Count == 3);
        }

        // Automatic unassigning after block using
        instances = G9Assembly.InstanceTools.GetInstancesOfType<G9CMultiInstanceTest>();
        Assert.That(instances.Count == 2);
    ...
    public void TestInstanceListener()
    {
        ...
        var instanceListener =
            ...
            (
                ...
                newInstance =>
                {
                    Assert.That(newInstance.GetUseCounter() == 1);
                ...
                instance =>
                {
                    Assert.That(instance.GetUseCounter() == 2);
                    instanceCount--;
                ...
                ex =>
                {
                    ...
                    Assert.That(ex.Message == exceptionMessage);
                    // Ignore
                }
            );
        // At first is 0
        Assert.That(instanceCount == 0);
        // New instance
        var testClass1 = new G9CInstanceListenerTest();
        Assert.That(instanceCount == 1);
        // Dispose Test
        testClass1.Dispose();
        Assert.That(instanceCount == 0);
        ...
        {
            Assert.That(e is ObjectDisposedException);
        }
    ...
    public void TestSafeThreadShock()
    {
        ...
        G9Assembly.PerformanceTools.MultiThreadShockTest(i =>
        {
            ...
            using (var newObject2 = new G9CThirdClass())
            {
                ...
                Assert.That(hash1 == h1);
                Assert.That(hash2 == h2);
            }
        }, numberOfRepetition);

        Thread.Sleep(369);
        Assert.That(count1 == 0 && count2 == 0);
    ...
    public void TestGetFieldsOfObject()
    {
        ...
        Assert.That(fieldsOfObject1.Count == 6 && fieldsOfObject2.Count == 6);

        // Get and test value from fields
        Assert.That(fieldsOfObject1[0].Name == nameof(G9CObjectMembersTest.StringTest1) &&
                    (string)fieldsOfObject1[0].GetValue() == "A" &&
                    fieldsOfObject1[0].GetValue<string>() == "A");
        Assert.That(fieldsOfObject1[1].Name == "StringTest2" &&
                    (string)fieldsOfObject1[1].GetValue() == "B" &&
                    fieldsOfObject1[1].GetValue<string>() == "B");
        Assert.That(fieldsOfObject2[2].Name.Contains("BackingField") &&
                    (decimal)fieldsOfObject2[2].GetValue() == (decimal)999.999 &&
                    fieldsOfObject2[2].GetValue<decimal>() == (decimal)999.999);
        Assert.That(fieldsOfObject2[3].Name.Contains("BackingField") &&
        ...
        catch (Exception ex)
        {
            ...
            Assert.That(ex is InvalidCastException);
        }
        ...
        Assert.That(fieldsOfObject2[5].GetValue<IPAddress>().Equals(IPAddress.Parse("192.168.1.1")));

        // It has one static public field
        Assert.That(fieldsOfObject3.Count == 1 && fieldsOfObject3[0].Name == "StaticIpAddressTest1" &&
                    fieldsOfObject3[0].GetValue<IPAddress>().Equals(IPAddress.Any));

        // It has one private static public field (BackingField)
        Assert.That(fieldsOfObject4.Count == 1 &&
        ...
        Assert.That(fieldsOfObject5.Count == 6);
        ...
        Assert.That(fieldsOfObject5.Count == 3);
        ...
        Assert.That(fields.Count == 3 && fields.Count(s => s.Name == "_age") == 1);
        ...
        Assert.That(fields.Count == 6 && ageFields.Length == 2 && ageFields[0].GetValue<int>() == 39 &&
                    ageFields[1].GetValue<int>() == 99);

        // Test on type
        // Without considerInheritedParent
        fields = G9Assembly.ReflectionTools.GetFieldsOfType(typeof(G9CObjectChild));
        Assert.That(fields.Count == 3 && fields.Count(s => s.Name == "_staticAge") == 1);
        ...
        Assert.That(ageFields[0].GetValueOnAnotherObject<int>(objectChildWithParent) == 39 &&
                    ageFields[1].GetValueOnAnotherObject<int>(objectChildWithParent) == 99);

        // Test attributes
        Assert.That(ageFields[0].GetCustomAttribute<IgnoreDataMemberAttribute>(true) != null &&
    ...
    public void TestGetPropertiesOfObject()
    {
        ...
        Assert.That(fieldsOfObject2.Count == 1);
        ...
        Assert.That(fieldsOfObject1.Count == 3 && fieldsOfObject2.Count == 3);

        // Get and test value from fields
        Assert.That(fieldsOfObject1[0].Name == nameof(G9CObjectMembersTest.DecimalTest1) &&
                    (decimal)fieldsOfObject1[0].GetValue() == 999.999m &&
                    fieldsOfObject1[0].GetValue<decimal>() == 999.999m);
        Assert.That(fieldsOfObject1[1].Name == "DecimalTest2" &&
                    (decimal)fieldsOfObject1[1].GetValue() == 369.963m &&
                    fieldsOfObject1[1].GetValue<decimal>() == 369.963m);
        Assert.That(fieldsOfObject2[2].Name == "StaticIpAddressTest2" &&
        ...
        Assert.That(fieldsOfObject1[0].GetValue<decimal>() == 639.963m);

        fieldsOfObject2[2].SetValue(IPAddress.Broadcast);
        Assert.That(fieldsOfObject2[2].GetValue<IPAddress>().Equals(IPAddress.Broadcast));

        // It don't have public static property
        Assert.That(fieldsOfObject3.Count == 0);
        ...
        fieldsOfObject5 = G9Assembly.ReflectionTools.GetPropertiesOfObject(object5,
            G9EAccessModifier.Everything, s => s.Name.Contains("1"));
        Assert.That(fieldsOfObject5.Count == 1);
        ...
        Assert.That(properties.Count == 1 && properties.Count(s => s.Name == "FullName") == 1);

        // With considerInheritedParent
        properties =
            G9Assembly.ReflectionTools.GetPropertiesOfObject(objectChildWithParent,
                considerInheritedParent: true);
        Assert.That(properties.Count == 2 && properties[0].GetValue<string>() == "G9TM" &&
        ...
        // Test attributes
        Assert.That(properties[0].GetCustomAttribute<IgnoreDataMemberAttribute>(true) != null &&
    ...
    public void TestGetMethodsOfObject()
    {
        ...
        Assert.That(fieldsOfObject1.Count == 13 && fieldsOfObject2.Count == 13);

        // Get and test value from methods
        Assert.That(fieldsOfObject1[5].MethodName == nameof(G9CObjectMembersTest.TestMethod1) &&
        ...
        catch (Exception ex)
        {
            ...
            Assert.That(ex is TargetParameterCountException);
        }
        ...
        Assert.That(getAgeMethods.Length == 2 &&
        ...
        // Test attributes
        Assert.That(getAgeMethods[0].GetCustomAttribute<OnSerializedAttribute>(true) != null &&
    ...
    public void TestGetGenericMethodsOfObject()
    {
        ...
        Assert.That(fieldsOfObject1.Count == 0);
        ...
        Assert.That(fieldsOfObject1.Count == 2 && fieldsOfObject2.Count == 2);

        // Get and test value from methods
        Assert.That(fieldsOfObject1[0].MethodName == nameof(G9CObjectMembersTest.TestGenericMethod) &&
                    fieldsOfObject1[0]
...
#if NETCOREAPP2_0_OR_GREATER
        Assert.That(fieldsOfObject1[1].MethodName == nameof(G9CObjectMembersTest.TestGenericMethod) &&
        ...
        Assert.That(fieldsOfObject3.Count == 1);

        // It don't have a private static generic method
        Assert.That(fieldsOfObject4.Count == 0);
        ...
        Assert.That(genericMethods.Count == 1 &&
        ...
        genericMethods =
            G9Assembly.ReflectionTools.GetGenericMethodsOfObject(objectChildWithParent,
                considerInheritedParent: true);
        Assert.That(genericMethods.Count == 2 &&
        ...
        // Test attributes
        Assert.That(genericMethods[0].GetCustomAttribute<OnSerializedAttribute>(true) != null &&
    ...
    public void TestGetAllMembersOfObject()
    {
        ...
        Assert.That(fieldsOfObject1.Fields.Count == 6 && fieldsOfObject1.Properties.Count == 3 &&
                    fieldsOfObject1.Methods.Count == 13 && fieldsOfObject1.GenericMethods.Count == 2);
        Assert.That(fieldsOfObject2.Fields.Count == 6 && fieldsOfObject2.Properties.Count == 3 &&
    ...
    public void TestGetMembersFromStaticObject()
    {
        ...
        {
            Assert.That(ex is MemberAccessException && ex.Message == "Cannot create an abstract class.");
        }

        // Get fields of type
        var staticFields = G9Assembly.ReflectionTools.GetFieldsOfType(typeof(G9DtStaticType));
        // Total fields
        Assert.That(staticFields.Count == 2);
        // Test static field
        Assert.That(
        ...
        // Total properties
        Assert.That(staticProperties.Count == 1);
        // Test static property
        Assert.That(
        ...
        // Total methods
        Assert.That(staticMethods.Count == 9);
        // Test static method
        Assert.That(
        ...
        // Total generic methods
        Assert.That(staticGenericMethods.Count == 1);
        ...
        G9Assembly.PerformanceTools.MultiThreadShockTest(i =>
        {
            ...
            // Total generic methods
            Assert.That(genericMethodsList.Count == 1);
    ...
    public void TestCreateInstanceFromType()
    {
        ...
        Assert.That(testObject1.Name == "Okay");
        ...
        Assert.That(testObject2.ValueOfType == "G9TM");
        ...
        Assert.That(testObject3.Name == "Hello G9TM");
        testObject3 =
        ...
        Assert.That(testObject4.ObjectType1 == "G9TM" && testObject4.ObjectType2 == 999 &&
        ...
        Assert.That(Equals(testObject5A, testObject5B));
        ...
        catch (Exception e)
        {
            ...
            Assert.That(e is MissingMethodException);
        }
        ...
        Assert.That(Equals(gTypeA.ValueOfType, default(IPAddress)));
        ...
        Assert.That(gTypeB.ObjectType1 == IPAddress.IPv6Loopback && gTypeB.ObjectType2 == int.MaxValue &&
    ...
    public void TestMergeAndCompareObjectsValues()
    {
        ...
        Assert.That(objectA.Name == "G9TM" && objectA.Age == 32 &&
        ...
        {
            Assert.That(e.Message == @"The members can't merge their values.
...
In the second object, the member's name is 'Age' with the value '109' and the type 'System.String'." &&
         ...
         */
        Assert.That(objectB.Name != "G9TM 2" && objectB.Age == 99 &&
...
In the second object, the member's name is 'Age' with the value 'nine' and the type 'System.String'." &&
         ...
         *   The merging process ignores the "Age" member because of mismatching in type.
         */
        Assert.That(objectB.Age == 99 && objectB.Age.ToString() != objectC2.Age &&
        ...
        // The first test just recognizes the default value.
        Assert.That(objectA.GetTime() == new TimeSpan(9, 9, 9) && objectB.GetTime() == new TimeSpan(3, 6, 9) &&
        ...
        Assert.That(objectA.Age != objectB.Age && objectA.ExDateTime == objectB.ExDateTime);
         ...
         */
        Assert.That(objectB.Age == 99 && objectC2.Age == "nine");
        ...
        G9Assembly.PerformanceTools.MultiThreadShockTest(i =>
        {
            ...
            Assert.That(newObjectB.Age == 99 && newObjectC2.Age == stringNumber);
            ...
            Assert.That(newObjectB.Age == intNumber);
        ...
        Assert.That(G9Assembly.ReflectionTools.CompareObjectsValues(compareObjectA, compareObjectB,
            out var unequalMembers), Is.False);
        Assert.That(unequalMembers.Count == 1 && unequalMembers[0].Item1.Name == unequalMembers[0].Item2.Name &&
    ...
    {
        var targetObject = new G9DtObjectForAttributes();

        var attr1 = G9Assembly.ReflectionTools.GetCustomAttributes<G9AttrCustomForTestAttribute>(targetObject,
            nameof(targetObject.Name), false);
        var attr2 = G9Assembly.ReflectionTools.GetCustomAttributes(typeof(G9AttrCustomForTestAttribute),
            targetObject, nameof(targetObject.Name), false);

        var attr3 = G9Assembly.ReflectionTools
            .GetCustomAttributes<G9AttrCustomForTestAttribute, G9DtObjectForAttributes>(targetObject,
                s => s.Name
                , false);

        var attr4 = G9Assembly.ReflectionTools.GetCustomAttributes(typeof(G9AttrCustomForTestAttribute),
            targetObject, s => s.Name, false);

        Assert.That(attr1.Length == 0 && attr2.Length == 0 && attr3.Length == 0 && attr4.Length == 0);

        attr1 = G9Assembly.ReflectionTools.GetCustomAttributes<G9AttrCustomForTestAttribute>(targetObject,
            nameof(targetObject.Family), false);
        attr2 = G9Assembly.ReflectionTools.GetCustomAttributes(typeof(G9AttrCustomForTestAttribute), targetObject,
            nameof(targetObject.Family), false);

        attr3 = G9Assembly.ReflectionTools
            .GetCustomAttributes<G9AttrCustomForTestAttribute, G9DtObjectForAttributes>(targetObject,
                s => s.Family
                , false);

        attr4 = G9Assembly.ReflectionTools.GetCustomAttributes(typeof(G9AttrCustomForTestAttribute), targetObject,
            s => s.Family, false);

        Assert.That(attr1[0].Hint == "Test 1" && ((G9AttrCustomForTestAttribute)attr2[1]).Hint == "Test 2" &&
                    ((G9AttrCustomForTestAttribute)attr4[2]).Hint == "Test 3" && attr1.Length == 3);
    }
    ...
    public void TestPerformanceMethods()
    {
        ...
        Assert.That(result1.AverageExecutionTimeOnMultiCore == null &&
        ...
        Assert.That(result2.AverageExecutionTimeOnMultiCore != null &&
        ...
        Assert.That(result3.AverageExecutionTimeOnMultiCore != null &&
        ...
        Assert.That(comparativeResultB.SortedPerformanceSpeedPercentageForMultiCore.Count == 2 &&
    ...
    public void TestCryptographyMethods()
    {
        ...
        Assert.That(!string.IsNullOrEmpty(aesEncryptionText));

        // AES decrypt, default config
        var aesDecryptionText = aesCryptography.DecryptString(aesEncryptionText);
        Assert.That(!string.IsNullOrEmpty(aesDecryptionText) && aesDecryptionText == testText);
        ...
        Assert.That(!string.IsNullOrEmpty(aesEncryptionText));
        aesDecryptionText = aesCryptography.DecryptString(aesEncryptionText);
        Assert.That(!string.IsNullOrEmpty(aesDecryptionText) && aesDecryptionText == newText);
        ...
        Assert.That(!string.IsNullOrEmpty(aesDecryptionText) && aesDecryptionText == testText);
#else
            Assert.That(!string.IsNullOrEmpty(aesDecryptionText) && aesDecryptionText.Trim('\0') == testText);
#endif
        ...
        G9Assembly.PerformanceTools.MultiThreadShockTest(rndNumber =>
        {
            ...
            Assert.That(!string.IsNullOrEmpty(aesEncryptionTextNew));
            var aesDecryptionTextNew =
                aesCryptography.DecryptString(aesEncryptionTextNew);
            Assert.That(aesDecryptionTextNew == newTextTest);
        }, 9_999);
    ...
    public void TestGeneralTools()
    {
        ...
        Assert.That(byteSize == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.Byte));
        Assert.That(kb == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.KiloByte));
        Assert.That(mb == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.MegaByte));
        Assert.That(gb == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.GigaByte));
        Assert.That(tb == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.TeraByte));
        Assert.That(pb == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.PetaByte));
        Assert.That(eb == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.ExaByte));
        Assert.That(zb == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.ZettaByte));
        Assert.That(yb == G9Assembly.GeneralTools.ConvertByteSizeToAnotherSize(byteSize, G9ESizeUnits.YottaByte));


        Assert.That(G9Assembly.GeneralTools.GetAssemblyVersion(typeof(G9Assembly).Assembly) ==
                    typeof(G9Assembly).Assembly.GetName().Version?.ToString());


        Assert.That(G9Assembly.GeneralTools.GetAssemblyVersion(GetType().Assembly) ==
    ...
    public void TestInputOutputTools()
    {
        ...
        Assert.That(G9Assembly.InputOutputTools.CheckDirectoryPathValidation(directory1, false, false, false) ==
                    G9EPatchCheckResult.Correct);
        Assert.That(G9Assembly.InputOutputTools.CheckDirectoryPathValidation(directory2, false, false, false) ==
                    G9EPatchCheckResult.Correct);
        Assert.That(G9Assembly.InputOutputTools.CheckDirectoryPathValidation(directory3, false, false, false) ==
                    G9EPatchCheckResult.PathNameIsIncorrect);
        Assert.That(G9Assembly.InputOutputTools.CheckDirectoryPathValidation(directory4, false, false, false) ==
                    G9EPatchCheckResult.PathNameIsIncorrect);
        ...
        Assert.That(G9Assembly.InputOutputTools.CheckFilePathValidation(file1, false, false, false) ==
                    G9EPatchCheckResult.Correct);
        Assert.That(G9Assembly.InputOutputTools.CheckFilePathValidation(file2, false, false, false) ==
                    G9EPatchCheckResult.Correct);
        Assert.That(G9Assembly.InputOutputTools.CheckFilePathValidation(file3, false, false, false) ==
                    G9EPatchCheckResult.PathNameIsIncorrect);
        Assert.That(G9Assembly.InputOutputTools.CheckFilePathValidation(file4, false, false, false) ==
                    G9EPatchCheckResult.PathNameIsIncorrect);
        ...
        // Get path
        Assert.That(!string.IsNullOrEmpty(G9Assembly.InputOutputTools.GetExecutableDirectory()));
        Assert.That(!string.IsNullOrEmpty(G9Assembly.InputOutputTools.GetBaseCurrentDirectory()));
        ...
        var embStructure = new List<G9DtEmbeddedResourceFile>
        {
            new("EmbeddedResources.Test.Test.1.png", "ebr_copy_test/1/1.png"),
            new("EmbeddedResources.Test.Test.2.png", "ebr_copy_test/1/2.png"),
            new("EmbeddedResources.Test.Test.3.png", "ebr_copy_test/1/3.png"),
            new("EmbeddedResources.Test.Test.a.txt", textFilePath)
        };
        ...
        {
            Assert.That(e.Message.StartsWith("The specified embedded resource file is not found in the address:"));
        }

        // Pass
        Assert.That(G9Assembly.InputOutputTools.EmbeddedResourceGetStreamFromFile(GetType().Assembly, mbrPath1)
            .Length == 5429);
        ...
        Assert.That(File.ReadAllText(textFilePath) == "This Is G9Team.");
